    ...
    <div className="App">
      ...
      <footer className="App-footer">
        <p>
          ...
          {' '}元のPython版は<a href="https://github.com/kuronos357/marine-object-counter" target="_blank" rel="noopener noreferrer">ここ</a>で公開しています。<br />
          {` `}旧版はまだ<a href="https://marine-object-counter-web.vercel.app/" target="_blank" rel="noopener noreferrer">ここ</a>で公開しています。 但し気まぐれで消えます。
        </p>
      </footer>
    </div>
  );
