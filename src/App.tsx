...
function App() {
  ...
  return (
    <div className="App">
      <header className="App-header"><h1>海中浮遊物カウンター (Web版)</h1></header>
      <main>
      ...
      <footer className="App-footer">
        <p>
          作成： <a href="https://github.com/kuronos357" target="_blank" rel="noopener noreferrer">kuronos357</a>/奥平和哲
          {``}このコードのリポジトリは<a href="https://github.com/kuronos357/marine-object-counter-web" target="_blank" rel="noopener noreferrer">こちら</a>で公開しています。
          {' '}元のPython版は<a href="https://github.com/kuronos357/marine-object-counter" target="_blank" rel="noopener noreferrer">こちら</a>で公開しています。
        </p>
      </footer>
    </div>
  );
